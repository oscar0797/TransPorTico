        ...
        <div class="container-fluid"><br>
            <header>
                <div id="mesajeResult" class="row alert  alert-info">
                    ...
                    <span id="mesajeResultText">Digite los datos del chofer y presione guardar</span>
                </div>
            </header>
            <!-- ********************************************************** -->
                            ...
                            <form >
                                <div class="form-row col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <div class="form-group col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                        <label for="" >Verifique que la cédula esté registrada*</label>
                                ...
                                <div class="form-row col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <div class="form-group col-xs-12 col-sm-4 col-md-4 col-lg-4" id="groupTipoLicencia">
                                        <label for="inputTipoLicencia">Seleccione el Tipo de Lincencia*</label>
            ...
            <!-- ********************************************************** -->
            <!-- MODAL CONFIRMACIÓN ELIMINAR UN CHOFER ----------------------->
            <!-- ********************************************************** -->
            <div id="topModal">
